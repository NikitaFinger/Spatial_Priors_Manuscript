...
total_distance_traveled_m = sum(sqrt(diff(xyz(:, 1)).^2 + diff(xyz(:, 2)).^2 + diff(xyz(:, 3)).^2)); % Total distance traveled in meters

click_data.total_time_traveled_s = total_time_traveled_s 
click.data.total_distance_traveled_m = total_distance_traveled_m
