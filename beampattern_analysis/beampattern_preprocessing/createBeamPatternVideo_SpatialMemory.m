...
%1/17/2023
     bpp.mic_loc(3,:)=[-0.10138038635253906	2.28451318359375	1.2462823486328125]; %original
        close all;
        ...
        if frames_limit_hard
            ...
            frames = max(frames(1), ...
                ...
                min(call_track_locs(calls_with_track(find(bpp.proc.chk_good_call, 1, 'last')))+20, ...
                frames(end));
        end
