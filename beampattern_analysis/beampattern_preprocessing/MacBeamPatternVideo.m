...
function createBeamPatternVideo(freq_desired, side_view, save_movie)
    addpath '/Volumes/pbs-mosslab/Magdiel/Analysis/beampattern_analysis/beampattern_preprocessing'
    ...
    mic_proc_dir = '/Volumes/pbs-mosslab/Magdiel/Data/Preprocessing/Mic/Beam_Output/';
...
outputDir = '/Volumes/pbs-mosslab/Magdiel/Data/Preprocessing/Mic/Beam_AV/batV';


    mic_data_dir = '/Volumes/pbs-mosslab/Magdiel/Data/Preprocessing/Mic/Mic_Data_Detect';
  ...
  if save_movie
    ...
    v=VideoWriter(['/Volumes/pbs-mosslab/Magdiel/Data/Preprocessing/Mic/Beam_AV/batV/' out_fname '.mp4'], 'MPEG-4');
...
%       audiowrite(['Y:\Spatial Memory Project (Xiaoyan and Nikita)\beampattern_analysis\Working Code\proc_output\' trials(tt).name '.wav'],y./max(abs(y)),...
    ...
    delete(['/Volumes/pbs-mosslab/Magdiel/Data/Preprocessing/Mic/Beam_Output/' out_fname '.avi'])
  end
end
